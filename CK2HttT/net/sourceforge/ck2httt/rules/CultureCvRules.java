...
//					System.out.println("Added:  " + _culture + " to:  " + _group +" (afterstruct)");
					_culture = null;
				}
			...
			public boolean afterEmpty(Token t) {
				...
				if ((1 == _level) && (null != _culture)) {
					__list.add(new EU3Culture(_culture,_group));
//                                        System.out.println("Added:  " + _culture + " to:  " + _group + " (afterempty)");
					_culture = null;
				}
			...
			public boolean afterListData(Token t) {
				...
				_group = _lastName._value;				
				__list.add(new EU3Culture(_culture, _group));
//                                System.out.println("Added:  " + _culture + " to:  " + _group + " (afterlistdata)");
